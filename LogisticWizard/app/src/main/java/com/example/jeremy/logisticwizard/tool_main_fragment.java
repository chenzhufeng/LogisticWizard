...
public class tool_main_fragment extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tool_main_fragment, container, false);
        /*
     ...
     /*
        mDatabase = FirebaseDatabase.getInstance().getReference("tool_main_fragment");
...
//        toolRef = FirebaseDatabase.getInstance().getReference().child("tool_main_fragment");
